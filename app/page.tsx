...
export default function Home() {
  ...
  return (
    <main className="min-h-[100dvh] bg-transparent flex flex-col items-center justify-center p-4 pt-20 md:p-8 overflow-hidden relative z-10 transition-colors duration-300">
      <div className="max-w-7xl w-full flex flex-col md:flex-row items-center justify-center md:justify-between gap-4 md:gap-16 relative h-full">
        ...
        <div className="flex-1 relative w-full max-w-[170px] sm:max-w-[200px] md:max-w-[300px] lg:max-w-[360px] mx-auto z-10 mt-2 md:mt-0">
          <Tilt tiltMaxAngleX={10} tiltMaxAngleY={10} perspective={1000} className="relative z-10">
            <div className="relative w-full aspect-[3/4] rounded-2xl md:rounded-[2.5rem] overflow-hidden border border-white/10 shadow-2xl group cursor-pointer" onClick={() => setViewImage(true)}>
          ...
          {/* ----- SOL TƏRƏF (3 Element) - Daha kənara itələndi ----- */}
          ...
          {/* ----- SAĞ TƏRƏF (4 Element) - Daha kənara itələndi ----- */}
